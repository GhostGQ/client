  ...
  const steps = [
      ...
      content: (
        <div className={styles.section}>
          <div className={styles.fieldGroup}>
            <label>
              Название RU <span style={{color: 'red'}}>*</span>
            </label>
            <input
              className={`${styles.input} ${
                errors.title_ru ? styles.error : ''
              }`}
              value={data.title_ru}
              onChange={e => setData({...data, title_ru: e.target.value})}
            />
            {errors.title_ru && (
              <p className={styles.errorText}>Это обязательное поле</p>
            )}
          </div>
          <div className={styles.fieldGroup}>
            <label>
              Название UZ <span style={{color: 'red'}}>*</span>
            </label>
            <input
              className={`${styles.input} ${
                errors.title_uz ? styles.error : ''
              }`}
              value={data.title_uz}
          ...
          <div className={styles.fieldGroup}>
            <label>
              Описание RU <span style={{color: 'red'}}>*</span>
            </label>
            <textarea
              className={`${styles.textarea} ${
                errors.description_ru ? styles.error : ''
              }`}
          ...
          <div className={styles.fieldGroup}>
            <label>
              Описание UZ <span style={{color: 'red'}}>*</span>
            </label>
            <textarea
              className={`${styles.textarea} ${
                errors.description_uz ? styles.error : ''
              }`}
    ...
    },
    {
      ...
      content: (
        <div className={styles.section}>
          ...
          <div className={styles.fieldGroup}>
            <label>Ширина</label>
            {renderCheckboxGroup(widthOptions, data.width_ids, 'width_ids')}
          </div>
          <div className={styles.fieldGroup}>
          ...
          <div className={styles.fieldGroup}>
            ...
            {renderCheckboxGroup(dyeingOptions, data.dyeing_ids, 'dyeing_ids')}
          </div>
          <div className={styles.fieldGroup}>
            <label>Состав</label>
            {renderCheckboxGroup(
    ...
    },
    {
      ...
      content: (
        <div className={styles.section}>
          <p>
            <strong>Название RU:</strong> {data.title_ru}
          </p>
          <p>
            <strong>Категорий:</strong> {data.category_ids.join(', ')}
          </p>
          <p>
            <strong>Ширина:</strong> {data.width_ids.join(', ')}
          </p>
          <p>
            <strong>Плотность:</strong> {data.density_ids.join(', ')}
          </p>
          <p>
            <strong>Крашение:</strong> {data.dyeing_ids.join(', ')}
          </p>
          <p>
            <strong>Состав:</strong> {data.composition_ids.join(', ')}
          </p>
